+++
title = "(Preliminary) Course schedule"
...
#### Week 1 Overview & properties of graphs
+ SAND chapter 3
+ Readings:
	+ Borgatti, S.P et al “[Network Analysis in the Social Sciences](http://science.sciencemag.org/content/323/5916/892)” Science 323, 892 (2009).
	+ Butts, Carter T. “[Revisiting the Foundations of Network Analysis](http://science.sciencemag.org/content/325/5939/414)” Science 325, 414 (2009)
...
research” Social Networks p139-153
	+ Butts. 2003. “Network inference, error and informant (in)accuracy: a Bayesian
...
+ Lab: Introduction to RStudio; SANDr chapter 4 (Descriptive Analysis of Network Graph Characteristics)

#### Week 2 Local & global properties of graphs
+ SAND chapter 4 
+ Readings:
	...
	+ Lee, H., McCormick, T. H., Wildeman, C., and Hicken, M. (2015). Racial inequalities in connectedness to imprisoned individuals in the United States. Du Bois Review: Social Science Research on Race, 12: 269-282.
...
+ Class reading
	...
	+ Snijders, Tom A. B. 2011. “[Statistical Models for Social Networks](http://www.annualreviews.org/doi/pdf/10.1146/annurev-soc-081309-150106)” Annual Review
of Sociology 37:131-153
...
+ Lab: Continue SANDr chapter 6 (Statistical Models for Network Graphs)
 

#### Week 6 Peer influence & spillovers 
+ Class readings:
...
#### Week 7 Peer influence & spillovers 
+ Readings
	...
	+ Yann Bramoull ́e, Habiba Djebbari, and Bernard Fortin. Identification of peer effects through social networks. *Journal of Econometrics*, 150(1):41–55, 2009. ISSN 03044076. doi: 10.1016/j.jeconom. 2008.12.021.
+ Presentation readings:
...
+ SAND chapter 5
+ Class readings
	+ Breza, E., Chandrasekhar, A. G., McCormick, T. H., & Pan, M. (2017). Using aggregated relational data to feasibly identify network structure without network data (No. w23491). *National Bureau of Economic Research*.
	...
	+ Mark S. Handcock and Krista J. Gile. Modeling Social Networks From Sampled Data. *Annals of Applied Statistics*, 4(1):5–25, 2010. ISSN 0036-8075. doi: 10.1214/08-AOAS221.
...
+ Presentation readings:
	...
	+ David C. Bell, Benedetta Belli-McQueen, and Ali Haider. Partner Naming and Forgetting: Recall of Network Members. *Social Networks*, 29(2):279–299, 2007. ISSN 15378276. doi: 10.1080/ 10810730902873927.
+ Lab: Exploring missing data & egocentric graphs


#### Week 9 Network models in the era of "big data'' 
+ Class readings:
	...
	+ Cesare, N., Lee, H., McCormick, T. H., Spiro, E., and Zagheni, E. (2018+). Promises and pitfalls of using digital traces for demographic research. To appear, Demography.
	+ Goel, S., Watts, D. J., & Goldstein, D. G. (2012, June). The structure of online diffusion networks. In Proceedings of the 13th ACM conference on electronic commerce (pp. 623-638). ACM.
	+ Eagle, N. A. Pentland, and D. Lazer (2009), "Inferring Social Network Structure
